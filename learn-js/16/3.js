...
// 1.3 document.forms -> form 요소를 선택할 때 종종 사용함
...
// 3.8 기존 돔 트리와 연결
// 3.8.1 appendChild() 기존 요소의 마지막 자식으로 추가
// 3.8.2 insertBefore() 부모 요소의 특정 노드 앞에 자식으로 추가
