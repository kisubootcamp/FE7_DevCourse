...
// [] 대괄호 () 소괄호 {} 중괄호
// index, 배열의 요소의 첫번째부터 0이 부여가되고, 그 뒤로 순차적으로 1씩 증가
const arr = [10, "A", true, null, undefined, Symbol("id")]; //대괄호엔 모든값가능
console.log(arr[0]); //이런식으로 0,1,2,3 순으로 없는 값은 undefined로 나옵니다

// 객체 = 중괄호로 둘러 쌓여진 값 , 키와 값으로 구성된 자료입니다.
// 키와 값으로 구성된 속성들의 집합       키(key)+ 값(value) = 속성(property)
// 대괄호연산자, 마침표연산자 (객체의 값을 꺼낼때 )
const scoreObj = {
  mathScore: 90,
  engScore: 80,
  korScore: 70,
...
console.log(scoreObj.engScore); // 객체는 가장 많이 사용됨
