...
Car.prototype.start = function () {
    return console.log(`My car brand is ${this.brand}, The car has started.`)
}
...
Rectangle.prototype.area = function () {
    ...
    return console.log(`삼격형의 면적은 ${result} 입니다.`)
}
...
// **문제 설명:** 
// `Shape` 생성자 함수를 만들고, 
// `getType` 메서드를 프로토타입에 추가하여 "I am a shape."를 출력하도록 하세요.
...
// **문제 설명:** 
// `Circle` 생성자 함수를 만들고, 
// `getCircumference` 메서드를 프로토타입에 추가하여 원의 둘레를 계산하는 기능을 구현하세요.
...
// ### 문제 10
// **문제 설명:** 
// `Employee` 생성자 함수를 만들고, 
// `getDetails` 메서드를 프로토타입에 추가하여 
