// 연습 문제 1
// 문제 설명: Person 생성자 함수를 작성하고, greet 메서드를 프로토타입에 추가하세요.
...
// 연습 문제 2
// 문제 설명: Car 생성자 함수를 작성하고, start 메서드를 프로토타입에 추가하여
...
// 연습 문제 4
// 문제 설명: 문제 설명: Animal 생성자 함수를 만들고, speak 메서드를 프로토타입에 추가하여
...
// 연습 문제 6
// 문제 설명: Student 생성자 함수를 만들고, introduce 메서드를 프로토타입에 추가하여
// "Hi, I'm [name] and I'm a student."를 출력하도록 하세요.
...
// 연습 문제 7
// 문제 설명: Book 생성자 함수를 만들고, getSummary 메서드를 프로토타입에 추가하여
// "Title: [title], Author: [author]"를 출력하도록 하세요.
...
// 연습 문제 8
// 문제 설명: Shape 생성자 함수를 만들고, getType 메서드를 프로토타입에 추가하여
// "I am a shape."를 출력하도록 하세요.
function Shape() {}
...
// 연습 문제 9
// 문제 설명: Circle 생성자 함수를 만들고, getCircumference 메서드를 프로토타입에 추가하여
// 원의 둘레를 계산하는 기능을 구현하세요.
...
// 연습 문제 10
// 문제 설명: Employee 생성자 함수를 만들고, getDetails 메서드를 프로토타입에 추가하여
