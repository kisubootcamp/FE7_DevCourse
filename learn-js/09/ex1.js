...
/* 문제 설명: Rectangle 생성자 함수를 만들고, 면적을 계산하는 area 메서드를 프로토타입에 추가하세요.기본 제공 코드: */
...
/* 문제 설명: Animal 생성자 함수를 만들고, speak 메서드를 프로토타입에 추가하여 "Animal makes a sound"를 출력하도록 하세요.기본 제공 코드: */
function Animal() {}
