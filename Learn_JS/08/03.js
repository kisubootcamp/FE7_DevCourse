...
function BankAccount(balance) {
  ...
  this.deposit = function(amount) {
    this.balance += amount;
    console.log(`${amount}원 입금. 잔고: ${this.balance}￦`);
  }
  
  this.withdraw = function(amount) {
    if(this.balance >= amount) {
      this.balance -= amount;
      console.log(`${amount}원 출금. 잔고: ${this.balance}￦`);
    } else {
      console.log("잔액 부족");
    }
  }
  ...
  this.getBalance = function() {
    console.log(`현재 잔고: ${this.balance}￦`);
  }
}
...
function Airplane(model, capacity) {
  ...
  this.fly = function() {
    console.log(`${this.model} 비행기가 ${this.capacity}명을 태우고 비행`);
  }
}
...
function Movie(title, director, year) {
  ...
  this.getDetails = function() {
    console.log(`${this.title} - 감독: ${this.director}, 제작년도: ${this.year}`);
  }
}
...
function Time(hour, minute, second) {
  ...
  this.getTime = function() {
    console.log(`${this.hour}시 ${this.minute}분 ${this.second}초`);
  }
}
