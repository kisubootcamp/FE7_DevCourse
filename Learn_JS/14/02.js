...
// const copyUser = {...user}; // JSON.parse(JSON.stringinfy(user)), structedClone(user)
// user.addr.zipCode = 100;
...
// 이터러블한 객체
// 배열, map, set
const map = new Map([["name", "kim"], ["age", 20],]);
map.set("name", "kim");
map.set("age", 20);
