...
// 1.5 객체이 병합과 복사
// 1.5.1 병합(얕은 병합)
// 1.5.1.1 Objects.assign()
// 1.5.1.2 {...obj1 ...obj2}

// 1.5.2 복사
// 1.5.2.1 얕은 복사 -> 기본적으로 참조 데이터 얕은 복사
// 1.5.3 깊은 복사
// 1.5.3.1 JSON.parse(JSON.stringify(object))
// 1.5.3.2 structedClone()
...
// 1.10 객체의 불변성
// 1.10.1 Object.freeze() + Object.isFreeze() -> 프로퍼티의 수정, 추가, 삭제를 모두 막음
// 1.10.2 Object.seal() + Object.isSealed()-> 프로퍼티의 추가와 삭제를 막음
// 1.10.3 Object.preventExtensions() + Object.isExtensible()-> 프로퍼티의 추가만 막음