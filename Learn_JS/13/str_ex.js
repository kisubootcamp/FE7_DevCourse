...
const str = "istanbul";
// 여기에 코드를 작성하세요
console.log(str.toLocaleUpperCase('tr-TR')); // 터키어(tr-TR) 규칙 적용
...
const str = "Hello, World!";
const swappedStr = str.split("").map(char => {
...
console.log(swappedStr); // 출력: "hELLO, wORLD!"
// ---
