...
// 문세 객체를 제어하기 위한 모델
// 문서 객체? 웹 브라우저에 표시되는 HTML을 자바스크립트가 이해할 수 있는 객체형태로 변환한 것을 말함
...
// 문서 노드 -> document
// 요소 노드 -> div, p, a ...
// 속성 노드 -> id="title", class="a"
// 텍스트 노드 -> "안녕하세요", "강사님 잘생김"
// 주석 노드 <!-- -->

// 1. 문서 객체의 선택
// 1.1 getElemet...
// 1.2 querySeletor... -> 오늘날 권장
...
// 3.1 스타일 변경
// 3.1.1 liEl.style.color = 'red';

// 3.2 속성 추가
// 3.2.1 liEl.setAttribute('class', 'big');

// 3.3 속성 제거
// 3.3.1 liEl.removeAttribute('style');

// 3.4 속성 가져오기
// 3.4.1 liEl.getAttribute('class')
