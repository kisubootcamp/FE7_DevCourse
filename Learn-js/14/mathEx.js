// 1. 절댓값 계산하기 - 주어진 숫자의 절댓값을 반환하는 함수를 작성하세요.
...
// 2. 반올림하기 - 주어진 숫자를 반올림하는 함수를 작성하세요.
...
// 3. 최대값 찾기 - 주어진 두 숫자 중 최대값을 반환하는 함수를 작성하세요.
function getMax(a, b) {
  return Math.max(a, b);
}
// 테스트 케이스
...
// 4. 최소값 찾기 - 주어진 두 숫자 중 최소값을 반환하는 함수를 작성하세요.
function getMin(a, b) {
  return Math.min(a, b);
}
// 테스트 케이스
...
// 5. 제곱근 계산하기 - 주어진 숫자의 제곱근을 반환하는 함수를 작성하세요.
...
// 6. 무작위 정수 생성하기 - 주어진 범위 내에서 무작위 정수를 생성하는 함수를 작성하세요.
...
// 7. 거듭제곱 계산하기 - 주어진 숫자의 거듭제곱을 계산하는 함수를 작성하세요.
...
// 8. 삼각 함수 계산하기 - 주어진 각도의 사인을 계산하는 함수를 작성하세요. (각도는 라디안으로 입력)
...
// 9. 원의 면적 계산하기 - 주어진 반지름으로 원의 면적을 계산하는 함수를 작성하세요.
